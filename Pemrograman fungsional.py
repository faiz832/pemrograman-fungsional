...
def main():
    ...
    menu = ["Home","Data Agama per Provinsi","Total Pemeluk Agama Di Indonesia"]
    choice = st.sidebar.selectbox("pilih opsi anda", menu)

    if choice == "Home":
        st.write("Welcome to the home page")
    elif choice == "Data Agama per Provinsi":
    ...
    elif choice == "Total Pemeluk Agama Di Indonesia":
         tampilkan_total_pemeluk(data)
